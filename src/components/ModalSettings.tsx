...
export const Modal = ({ closeModal, onSubmit, defaultValue }: any) => {
  ...
  return (
    <div
      className="modal-container fixed z-50 flex w-full top-25 bottom-5 "
      onClick={(e) => {
        if (e.target.className === "modal-container") closeModal();
      }}
    >
      <div className="modal w-80 rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark overflow-auto">
